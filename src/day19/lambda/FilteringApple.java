...
public class FilteringApple {
    ...
    /*
     * @solution try 1 - 사과리스트에서 녹색 사과들만 필터링
     * @problem
     * - 만약 빨간색 사과를 필터링하고 싶다면??
     * - filterRedApples 를 만들것이냐
     * - 색깔이 더 다양하다면?
     *
     */
     ...
     * @ problem
     * - 만약 핅터기준이 색상이 아니라 무게라면?
     * - 무게 파라미터를 가진 메서드 filterApplesByWeight 를 만들건가?
     * - 만약 필터기준이 색상 + 무게
     * - 어짜피 조건문 빼고 코드가 똑같을 것 같은데?
     */

    public static List<Apple> filterApllesByColor(List<Apple> inventory, Color color) {
    ...
    // 제네릭 필터 메서드 생성
    // 제네릭 필드 메서드 생성할때 return 타입 앞에 제네릭이란것을 나타내기 위해 <T>를 추가한다.
